...
public class delete_window {
	...
	private void initialize() {
		...
		lblNewLabel = new JLabel("Supprimer des etudiants");
	...
	public static void update(JComboBox jComboBox) {
		ResultSet res1 = Model_class.getEtudiantField(Model_class.getConnection());
		try {
			while (res1.next()) {
				jComboBox.addItem(res1.getString("nom"));
				 }
